          ...
          <div class="column is-3">
            <aside class="is-medium menu">
                  ...
                  <ul class="menu-list">
                    ...
                    <li><a href="/commands/admin.php" class="is-active"><i class="fas fa-briefcase"></i> Admin</a></li>
                  </ul>
                  <p class="menu-label">
                    Informations
                  </p>
              ...
              <div class="column is-9">
                <div class="content is-medium">
                  ...
                  <div class="box">
                    <h4 id="let" class="title is-3"><span class="tag is-info is-large">mention</span></h4>
                    <article class="message is-info">
                      <span class="icon has-text-info">
                        <i class="fas fa-info-circle"></i>
                      </span>
                      <div class="message-body">
                          Allow you to mention any role
                      </div>
                    </article>
                    <pre><code class="language-javascript">Usage : --mention 'rolename'</code></pre>
                  </div>

                  <div class="box">
                    <h4 id="let" class="title is-3"><span class="tag is-info is-large">annonce</span></h4>
                    <article class="message is-info">
                      <span class="icon has-text-info">
                        <i class="fas fa-info-circle"></i>
                      </span>
                    ...
                    <pre><code class="language-javascript">Usage : --annonce 'rolename' 'message'</code></pre>
                  </div>
